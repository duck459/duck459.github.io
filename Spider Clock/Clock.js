...
let currentTimezone = Intl.DateTimeFormat().resolvedOptions().timeZone; // Default timezone
...
function initDefaultClock() {
    // 1. Set the continent dropdown visually to empty ("-- Select Continent --")
    continentSelect.value = "";
    
    // 2. Populate the city dropdown with the empty state ("-- Select a City --")
    populateCities("");
}
